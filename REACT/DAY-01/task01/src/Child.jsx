...
const Child = ({prop}) => {
  ...
  return (
    <div style={{display: "flex", justifyContent:"center"}}>
      <div style={{display: "flex", flexDirection: "column", justifyContent:"center", alignItems: "center", lineHeight: "1rem", boxShadow: "0 0 10px grey", width:"25%", height:"50vh", padding:"20px"}}>
